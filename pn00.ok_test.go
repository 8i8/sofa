...
func TestPn00(t *testing.T) {
	...
	tests := []struct {
		...
		fn  func(a1, a2, a3, a4 float64) (
			c1 float64, c2, c3, c4, c5, c6 [3][3]float64)
	}{
		{"cgo", CgoPn00},
		{"go", GoPn00},
	}
	...
	for _, test := range tests {
		...
		vvd(t, rb[0][0], 0.9999999999999942498, 1e-12,
			tname, "rb11")
		vvd(t, rb[0][1], -0.7078279744199196626e-7, 1e-18,
			tname, "rb12")
		vvd(t, rb[0][2], 0.8056217146976134152e-7, 1e-18,
			tname, "rb13")

		vvd(t, rb[1][0], 0.7078279477857337206e-7, 1e-18,
			tname, "rb21")
		vvd(t, rb[1][1], 0.9999999999999969484, 1e-12,
			tname, "rb22")
		vvd(t, rb[1][2], 0.3306041454222136517e-7, 1e-18,
			tname, "rb23")

		vvd(t, rb[2][0], -0.8056217380986972157e-7, 1e-18,
			tname, "rb31")
		vvd(t, rb[2][1], -0.3306040883980552500e-7, 1e-18,
			tname, "rb32")
		...
		vvd(t, rn[0][0], 0.9999999999536069682, 1e-12,
			tname, "rn11")
		vvd(t, rn[0][1], 0.8837746144872140812e-5, 1e-16,
			tname, "rn12")
		vvd(t, rn[0][2], 0.3831488838252590008e-5, 1e-16,
			tname, "rn13")

		vvd(t, rn[1][0], -0.8837590456633197506e-5, 1e-16,
			tname, "rn21")
		vvd(t, rn[1][1], 0.9999999991354692733, 1e-12,
			tname, "rn22")
		vvd(t, rn[1][2], -0.4063198798559573702e-4, 1e-16,
			tname, "rn23")

		vvd(t, rn[2][0], -0.3831847930135328368e-5, 1e-16,
			tname, "rn31")
		vvd(t, rn[2][1], 0.4063195412258150427e-4, 1e-16,
			tname, "rn32")
		...
		vvd(t, rbpn[0][0], 0.9999989440499982806, 1e-12,
			tname, "rbpn11")
		vvd(t, rbpn[0][1], -0.1332880253640848301e-2, 1e-14,
			tname, "rbpn12")
		vvd(t, rbpn[0][2], -0.5790760898731087295e-3, 1e-14,
			tname, "rbpn13")

		vvd(t, rbpn[1][0], 0.1332856746979948745e-2, 1e-14,
			tname, "rbpn21")
		vvd(t, rbpn[1][1], 0.9999991109064768883, 1e-12,
			tname, "rbpn22")
		vvd(t, rbpn[1][2], -0.4097740555723063806e-4, 1e-14,
			tname, "rbpn23")

		vvd(t, rbpn[2][0], 0.5791301929950205000e-3, 1e-14,
			tname, "rbpn31")
		vvd(t, rbpn[2][1], 0.4020553681373702931e-4, 1e-14,
			tname, "rbpn32")
...
func BenchmarkPn00(b *testing.B) {
